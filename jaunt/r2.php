...
$r = array(
    'id'=>'2344r2s3s4', // унікальний ID запису реєстрації 
    'customer'=>array(
        'id'=>12262345, // унікальний ID користувача, що записуюється на подію
        ...
        ,
        'jaunt_passport_number'=>'MS 123456',
        'jaunt_citizenship'=>'Spain',
        'jaunt_date_of_birth'=>'2008-11-30'
    ),
    'jaunt'=> array(
        'id'=>12345,
